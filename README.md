> [!IMPORTANT]
> **Este repositório foi arquivado.** O depurador — adaptador, protocolo e o
> plugin do servidor — passou a fazer parte do
> **[PawnPro-Core](https://github.com/NullSablex/PawnPro-Core)**, onde o
> desenvolvimento continua: é de lá que saem o código, as releases e a
> documentação, e é lá que vão issues e pull requests.
>
> O código publicado aqui permanece sob **AGPL-3.0-or-later**; no núcleo vale a
> licença dele. O histórico e as releases deste repositório ficam de pé, para
> referência.
